...
declare -A DEFAULTS=(
    ...
    [DOCSCAN_CONVERT_CONCURRENCY]="8"
    [DOCSCAN_MAX_QUEUED]="10"
)
ORDER=(DOCSCAN_API_KEY DOCSCAN_CORS_ORIGINS DOCSCAN_MAX_UPLOAD_MB DOCSCAN_RETENTION_HOURS DOCSCAN_CONVERT_CONCURRENCY DOCSCAN_MAX_QUEUED)
